...
namespace ChartLibrary
{
    public class SplitLineGraph : VisualElement
    {
        ...
        {
            UxmlIntAttributeDescription m_RangeAttribute = new UxmlIntAttributeDescription { name = "range" };
        ...
        static CustomStyleProperty<Color> s_GraphColor = new CustomStyleProperty<Color> ("--graph-color");
