...
namespace ChartLibrary
{
    public class PieChart : VisualElement
    {
        ...
        {
            UxmlStringAttributeDescription m_TestValues = new UxmlStringAttributeDescription { name = "test-values" };
            
            UxmlColorAttributeDescription m_TestColor = new UxmlColorAttributeDescription { name = "test-color" };
        ...
        static CustomStyleProperty<Color>[] s_SliceColors = {
            new CustomStyleProperty<Color>("--color-slice-1"),
            new CustomStyleProperty<Color>("--color-slice-2"),
            new CustomStyleProperty<Color>("--color-slice-3"),
            new CustomStyleProperty<Color>("--color-slice-4"),
            new CustomStyleProperty<Color>("--color-slice-5"),
            new CustomStyleProperty<Color>("--color-slice-6"),
            new CustomStyleProperty<Color>("--color-slice-7"),
            new CustomStyleProperty<Color>("--color-slice-8"),
        };
