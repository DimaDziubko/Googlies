...
namespace Unity.Theme.Editor
{
    public class ThemeWindowEditor : EditorWindow
    {
        ...
        private readonly Dictionary<string, UITheme> uiThemeColors = new Dictionary<string, UITheme>();
        private DropdownField _dropdownCurrentTheme;
        ...
        {
            _dropdownCurrentTheme.choices = config.ThemeNames.ToList();
            _dropdownCurrentTheme.value = config.CurrentThemeName;
        }
        ...
        public void CreateGUI()
        {
            ...
            _dropdownCurrentTheme = panel.Query<DropdownField>("dropdownCurrentTheme").First();

            UpdateDropdownCurrentTheme(config);

            _dropdownCurrentTheme.RegisterValueChangedCallback(evt => 
            {
