...
{
    public class DefeatLightEnemyStrategy : IDailyTaskStrategy
    {
        ...
        public DefeatLightEnemyStrategy(
        ...
        {
            if (unit.Type == UnitType.Light && !_model.IsReady && _isBattleRunning)
            {
        ...
        private void SetAdditionalDescription()
        {
            var additionalDescription = TimelineConfig
                .GetBattleRelatedWarrior(TimelineState.TimelineId, _navigator.CurrentBattleIdx, UnitType.Light).Name;
